This is a [Fastify](https://fastify.dev/) backend project bootstrapped with [brisket-create-app](https://github.com/HoaX7/brisket/tree/main/packages/brisket-create-app/).
